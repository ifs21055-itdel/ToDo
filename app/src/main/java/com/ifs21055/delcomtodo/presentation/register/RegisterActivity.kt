package com.ifs21055.delcomtodo.presentation.register
...
import com.ifs21055.delcomtodo.databinding.ActivityRegisterBinding
...
class RegisterActivity : AppCompatActivity() {
    ...
    private fun setupAction(){
        binding.apply {
            // Memberikan aksi jika text ke tampilan login dipilih
